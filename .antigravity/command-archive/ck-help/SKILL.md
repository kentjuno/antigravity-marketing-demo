---
name: akm:ck-help
description: AntigravityKit usage guide - just type naturally
...
Think harder.
All-in-one AntigravityKit guide. Run the script and present output based on type markers.
...
```bash
python .antigravity/scripts/ck-help.py "$ARGUMENTS"
```
...
- Use global (~/.antigravity/.antigravity.json) for personal preferences like language, issue prefix style
- Use local (./.antigravity/.antigravity.json) for project-specific paths, naming conventions
