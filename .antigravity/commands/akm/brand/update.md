...
Run the sync script:
```bash
node .antigravity/skills/brand-guidelines/scripts/sync-brand-to-tokens.cjs
```
...
node .antigravity/skills/brand-guidelines/scripts/inject-brand-context.cjs --json | head -30
