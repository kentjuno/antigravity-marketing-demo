...
|-------|------------|--------------|
| Researcher 1 | Product/Service Analysis | `README.md`, `ANTIGRAVITY.md`, `package.json`, codebase |
...
1. **Analyze Available Commands**
   - Run `python .antigravity/scripts/generate_catalogs.py --commands`
...
## Output
**IMPORANT**: Create/update following documents even docs exists in Step 1.2
- `ANTIGRAVITY.md` - Updated with marketing context
