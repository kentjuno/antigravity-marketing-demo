...
2. **ReviewWeb API Analysis** (if `$REVIEWWEB_API_KEY` available)
   - Reference: `.antigravity/skills/seo-optimization/references/reviewweb-api.md`
...
## API Reference
- ReviewWeb API: `.antigravity/skills/seo-optimization/references/reviewweb-api.md`
