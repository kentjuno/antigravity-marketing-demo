...
Execute AntigravityKit workflow tests with manual verification at each step.
...
```bash
python3 .antigravity/skills/test-orchestrator/scripts/scan-components.py --json --scenarios
```
