...
- If relevant, run `node .antigravity/skills/brand-guidelines/scripts/inject-brand-context.cjs --json` and incorporate:
  - Tone of voice
...
## Examples
```
/video:script:create youtube "complete guide to Google Antigravity"
...
/video:script:create short "AntigravityKit intro" --art-direction "Modern Tech Futurism"
```
