...
1. **Extract Video Content**
   ...
   - Run VidCap API:
     ...
     python .antigravity/skills/youtube-handling/scripts/vidcap.py article "<url>"

     # Or custom extraction for more control
     python .antigravity/skills/youtube-handling/scripts/vidcap.py summary-custom "<url>" \
