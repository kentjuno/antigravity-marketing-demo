/**
 * Shared utilities for AntigravityKit hooks
 *
...
const LOCAL_CONFIG_PATH = '.antigravity/.antigravity.json';
const GLOBAL_CONFIG_PATH = path.join(os.homedir(), '.antigravity', '.antigravity.json');
 ...
 * @param {Object} config - AntigravityKit config
 ...
 *   2. Global config (~/.antigravity/.antigravity.json) - user preferences
 *   3. Local config (./.antigravity/.antigravity.json) - project-specific overrides
 *
...
/**
 * Extract task list ID from plan resolution for Google Antigravity Tasks coordination
