/**
 * Environment loader with cascade: process.env > ~/.antigravity/.env > .antigravity/.env
 ...
 * Priority: process.env > ~/.antigravity/.env > .antigravity/.env
