...
function buildSubagentStopEmbed(input) {
  ...
  return {
    title: 'Google Antigravity Subagent Complete',
...
function buildAskUserPromptEmbed(input) {
  ...
  return {
    title: 'Google Antigravity Needs Input',
    description: 'Antigravity is waiting for user input',
...
function buildDefaultEmbed(input) {
  ...
  return {
    title: 'Google Antigravity Event',
