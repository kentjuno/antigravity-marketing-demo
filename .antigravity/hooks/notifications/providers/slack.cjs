...
function getTitle(hookType) {
  switch (hookType) {
    case 'Stop':
      return 'Google Antigravity Session Complete';
    case 'SubagentStop':
      return 'Google Antigravity Subagent Complete';
    case 'AskUserPrompt':
      return 'Google Antigravity Needs Input';
    default:
      return 'Google Antigravity Event';
  }
}
...
function formatMessage(input) {
  ...
  return {
    text: `Google Antigravity: ${hookType} in ${projectName}`, // Fallback required
