...
test('formatConfigPath with antigravityDir', formatConfigPath('/home/user/.antigravity').includes('.ckignore'));
test('formatConfigPath without antigravityDir', formatConfigPath(null) === '.antigravity/.ckignore');
test('formatConfigPath empty string', formatConfigPath('') === '.antigravity/.ckignore');
...
const blockError = formatBlockedError({
  ...
  tool: 'Bash',
  antigravityDir: '/home/user/project/.antigravity'
});
