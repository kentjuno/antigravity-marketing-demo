...
This guide explains how to install dependencies for Google Antigravity skills.
...
pip install -r .antigravity/skills/ai-multimodal/scripts/requirements.txt
...
```bash
cd .antigravity/skills/ai-multimodal/scripts
...
**ai-multimodal** (`.antigravity/skills/ai-multimodal/scripts/requirements.txt`):
...
```bash
cd .antigravity/skills/{skill-name}/scripts
...
2. **`.antigravity/skills/{skill-name}/.env`** (skill-specific config)
3. **`.antigravity/skills/.env`** (shared skills config)
4. **`.antigravity/.env`** (global Antigravity config)
...
```bash
chmod +x .antigravity/skills/*/scripts/*.py
```
...
# Run all tests
pytest .antigravity/skills/*/scripts/tests/ -v

# Check coverage across all skills
pytest .antigravity/skills/*/scripts/tests/ --cov=.antigravity/skills --cov-report=html
```
...
5. Open an issue: https://github.com/anthropics/antigravity-code/issues
