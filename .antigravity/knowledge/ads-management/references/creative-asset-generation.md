...
```bash
python3 .antigravity/skills/ai-artist/scripts/search.py "product shot ad" --domain examples
python3 .antigravity/skills/ai-artist/scripts/search.py "lifestyle marketing" --domain style
```
