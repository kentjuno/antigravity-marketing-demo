...
python3 .antigravity/skills/ai-artist/scripts/search.py "<keywords>" --domain examples --max-results 3

# Step 2: Generate with Flash
.antigravity/skills/.venv/bin/python3 .antigravity/skills/ai-multimodal/scripts/gemini_batch_process.py \
  --task generate \
