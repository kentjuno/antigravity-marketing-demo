...
3. **.antigravity/.env file**
   ```bash
   echo 'GEMINI_API_KEY=your-api-key' > .antigravity/.env
   ```

4. **.antigravity/skills/.env file** (shared across all Gemini skills)
   ```bash
   echo 'GEMINI_API_KEY=your-api-key' > .antigravity/skills/.env
   ```

5. **Skill directory `.env` file**
   ```bash
   echo 'GEMINI_API_KEY=your-api-key' > .antigravity/skills/your-skill/.env
   ```
