...
```bash
python .antigravity/skills/copywriting/scripts/extract-writing-styles.py --list        # List files
python .antigravity/skills/copywriting/scripts/extract-writing-styles.py --style <name> # Extract style
```
