...
def find_project_root(start_dir: Path) -> Path:
    """Find project root by looking for .antigravity directory."""
    for parent in [start_dir] + list(start_dir.parents):
        if (parent / '.antigravity').exists():
            return parent
    return start_dir
...
AI_MULTIMODAL_SCRIPTS = PROJECT_ROOT / '.antigravity' / 'skills' / 'ai-multimodal' / 'scripts'
