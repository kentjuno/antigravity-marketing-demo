...
**Brand:**
```bash
node .antigravity/skills/brand/scripts/inject-brand-context.cjs
node .antigravity/skills/brand/scripts/validate-asset.cjs <path>
```

**Tokens:**
```bash
node .antigravity/skills/design-system/scripts/generate-tokens.cjs -c tokens.json
node .antigravity/skills/design-system/scripts/validate-tokens.cjs -d src/
```
