...
python .antigravity/skills/design-system/scripts/search-slides.py "metrics dashboard" -d layout

# Contextual recommendation
python .antigravity/skills/design-system/scripts/search-slides.py "traction slide" \
