...
function Get-RemediationCommands {
    ...
    if ($hasPythonFailed) {
        ...
        Write-Host ".\.antigravity\skills\.venv\Scripts\Activate.ps1"
...
function Write-ErrorSummary {
    ...
    $summary = @{
        ...
        remediation = @{
            ...
            pip_retry = ".\.antigravity\skills\.venv\Scripts\Activate.ps1; pip install <package>"
        }
    }
...
function Show-Usage {
    ...
    Write-Host "  .antigravity\skills\INSTALLATION.md"
    Write-Host ""
}

# Show help
function Show-Help {
    Write-Host "Google Antigravity Skills Installation Script for Windows"
    Write-Host ""
    Write-Host "Usage:"
...
function Main {
    ...
    Write-Header "Google Antigravity Skills Installation (Windows)"
