...
- **AI Enhancement**: Improve content with Antigravity integration
...
│   ├── lib/                    # Utilities
│   │   ├── ai-bridge.cjs       # Antigravity CLI integration
...
### AI
- `GET /api/ai/status` - Check Antigravity availability
...
**Server (.antigravity/skills/marketing-dashboard/server/.env):**
```env
PORT=3457
...
**Frontend (.antigravity/skills/marketing-dashboard/app/.env):**
```env
...
Part of AntigravityKit Marketing toolkit.
