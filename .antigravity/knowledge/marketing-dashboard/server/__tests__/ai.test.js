/**
 * AI API Tests
 * Google Antigravity CLI integration, content enhancement, and generation
 */
...
describe('AI API', () => {
  describe('GET /api/ai/status - Check Antigravity availability', () => {
    it('should return status object', () => {
      const mockAvailable = true;

      const response = {
        available: mockAvailable,
        message: mockAvailable ? 'Google Antigravity ready' : 'Google Antigravity not found in PATH'
      };

      expect(response).toHaveProperty('available');
      expect(response).toHaveProperty('message');
      expect(response.message).toContain('Google Antigravity');
    });

    it('should indicate available when Antigravity found', () => {
      const response = {
        available: true,
    ...
    it('should indicate unavailable when Antigravity not found', () => {
      const response = {
        available: false,
        message: 'Google Antigravity not found in PATH'
      };
  ...
  describe('POST /api/ai/enhance - Enhance content', () => {
    ...
    it('should handle enhancement errors', () => {
      const errorResponse = {
        ...
        details: 'Google Antigravity not available'
      };
