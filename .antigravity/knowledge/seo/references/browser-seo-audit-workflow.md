...
```bash
cd .antigravity/skills/chrome-devtools/scripts && npm install
```
...
node screenshot.js --url https://example.com --full-page true \
  --output .antigravity/chrome-devtools/screenshots/seo-audit.png
```
...
node screenshot.js --url https://example.com \
  --output .antigravity/chrome-devtools/screenshots/atf.png
```
...
```bash
node evaluate.js --script "page.setViewport({width: 375, height: 812, isMobile: true})"
node screenshot.js --output .antigravity/chrome-devtools/screenshots/mobile.png
```
...
OUT=".antigravity/chrome-devtools/seo-audits/$SESSION"
mkdir -p "$OUT"

cd .antigravity/skills/chrome-devtools/scripts
