...
| `file_format_cheag_failed` | Invalid video format | Check specs |
| `duration_cheag_failed` | Video too long/short | Adjust duration |
| `picture_size_cheag_failed` | Image too small | Min 720p |
