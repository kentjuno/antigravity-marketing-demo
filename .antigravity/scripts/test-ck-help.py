...
Run: python3 .antigravity/scripts/test-ck-help.py
"""
...
def test_case(name, args, expected_patterns, unexpected_patterns=None):
    ...
    output = run_ag_help(*args) if args else run_ag_help()
...
def main():
    ...
    tests.append(test_case(
        "config guide",
        ["config"],
        [".antigravity.json", "Configuration", "locale", "codingLevel"]
    ))
