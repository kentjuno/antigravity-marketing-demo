...
Outputs YAML to stdout by default for easy consumption by Antigravity.
...
def generate_commands_yaml():
    ...
    catalog = {
        'metadata': {
            ...
            'description': 'Auto-generated catalog of all available commands in AntigravityKit Engineer',
...
def generate_skills_yaml():
    ...
    catalog = {
        'metadata': {
            ...
            'description': 'Auto-generated catalog of all available skills in AntigravityKit Engineer',
            'last_updated': datetime.now().strftime('%Y-%m-%d'),
