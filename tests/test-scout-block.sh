...
echo '{"tool_input":{"command":"ls -la"}}' | node .antigravity/hooks/scout-block.js
if [ $? -eq 0 ]; then
...
echo '{"tool_input":{"command":"ls node_modules"}}' | node .antigravity/hooks/scout-block.js 2>/dev/null
if [ $? -eq 2 ]; then
...
echo '{"tool_input":{"command":"cd .git/ && ls"}}' | node .antigravity/hooks/scout-block.js 2>/dev/null
if [ $? -eq 2 ]; then
...
echo '{"tool_input":{"command":"find __pycache__"}}' | node .antigravity/hooks/scout-block.js 2>/dev/null
if [ $? -eq 2 ]; then
...
echo '{"tool_input":{"command":"cat dist/bundle.js"}}' | node .antigravity/hooks/scout-block.js 2>/dev/null
if [ $? -eq 2 ]; then
...
echo '{"tool_input":{"command":"rm -rf build/"}}' | node .antigravity/hooks/scout-block.js 2>/dev/null
if [ $? -eq 2 ]; then
...
echo '{"tool_input":{"command":"cat .env"}}' | node .antigravity/hooks/scout-block.js
if [ $? -eq 0 ]; then
...
echo 'invalid json' | node .antigravity/hooks/scout-block.js 2>/dev/null
if [ $? -eq 2 ]; then
...
echo '' | node .antigravity/hooks/scout-block.js 2>/dev/null
if [ $? -eq 2 ]; then
...
echo '{"tool_input":{}}' | node .antigravity/hooks/scout-block.js 2>/dev/null
if [ $? -eq 2 ]; then
...
echo '{"tool_input":{"command":""}}' | node .antigravity/hooks/scout-block.js 2>/dev/null
if [ $? -eq 2 ]; then
